...
public class RupeshAutoDriveToAprilTagOmni extends LinearOpMode  {
    ...
    private DcMotor backleftDrive  = null;  //  Used to control the right front drive wheel
    private DcMotor frontrightDrive    = null;  //  Used to control the left back drive wheel
